...
public class EmailService {
    ...
    /**
     * Send an account-activation email to a user created by an admin.
     * The activation link embeds the one-time token and expires in 72 hours.
     *
     * @param to              recipient email address
     * @param firstName       recipient first name (personalisation)
     * @param activationUrl   full URL the user must visit to activate their account
     */
    public void sendActivationEmail(String to, String firstName, String activationUrl) {
        String subject = "Activate your account";
        String html = buildActivationHtml(firstName, activationUrl);
        sendHtml(to, subject, html, "account activation");
    }
    ...
    private String buildActivationHtml(String firstName, String activationUrl) {
        return """
        <!DOCTYPE html>
        <html lang="en">
        <head>
              ...
              <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%%;background:#1e293b;border-radius:16px;overflow:hidden;box-shadow:0 20px 60px rgba(0,0,0,0.5);">
                ...
                <tr>
                  <td style="background:linear-gradient(135deg,#6366f1 0%%,#8b5cf6 100%%);padding:36px 40px 32px;text-align:center;">
                    <div style="display:inline-block;width:52px;height:52px;background:rgba(255,255,255,0.15);border-radius:14px;line-height:52px;font-size:24px;margin-bottom:16px;">✉️</div>
                    <h1 style="margin:0;color:#ffffff;font-size:22px;font-weight:700;letter-spacing:-0.3px;">You've been invited!</h1>
                  </td>
                </tr>
                <!-- Body -->
                <tr>
                  <td style="padding:36px 40px;">
                    <p style="margin:0 0 20px;color:#94a3b8;font-size:15px;line-height:1.7;">
                      Hi <strong style="color:#e2e8f0;">%s</strong>,<br/><br/>
                    ...
                    <table width="100%%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
                      <tr>
                        <td align="center">
                          <a href="%s" style="display:inline-block;background:linear-gradient(135deg,#6366f1,#8b5cf6);color:#ffffff;font-size:15px;font-weight:700;text-decoration:none;padding:14px 36px;border-radius:10px;letter-spacing:0.3px;">
                            Activate My Account
                          </a>
                        </td>
                      </tr>
                    ...
                    <table width="100%%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
                      <tr>
                        <td style="background:#1d2d44;border-left:3px solid #6366f1;border-radius:0 8px 8px 0;padding:12px 16px;">
                          <p style="margin:0 0 6px;color:#94a3b8;font-size:12px;">⏱ This link expires in <strong>72 hours</strong>. If the button doesn't work, copy this link:</p>
                          <p style="margin:0;color:#818cf8;font-size:11px;word-break:break-all;">%s</p>
                        </td>
                      </tr>
                    </table>
                    <hr style="border:none;border-top:1px solid #334155;margin:28px 0;"/>
                    <p style="margin:0;color:#475569;font-size:12px;line-height:1.6;">
                      If you didn't expect this invitation, you can safely ignore this email. No account will be activated without your action.
                    </p>
                  </td>
                </tr>
                <!-- Footer -->
                <tr>
                  <td style="background:#0f172a;padding:20px 40px;text-align:center;border-top:1px solid #1e293b;">
                    <p style="margin:0;color:#334155;font-size:11px;">© 2025 AppName · This is an automated email — please do not reply.</p>
                  </td>
                </tr>
              </table>
            </td></tr>
        ...
        """.formatted(firstName, activationUrl, activationUrl);
    }
